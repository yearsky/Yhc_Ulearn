        ...
        <div class="row" style="flex-grow: 1;">
            ...
            <div class="col-md-3 col-lg-6 col-xl-6 d-none d-md-block">
                <div class="dropdown float-left">
                    ...
                    <span class="ml-3"><a href="#">  Us </a></span>
                    <?php
        ...
        <div class="row m-0">
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 mt-3 d-none d-sm-block">
                <ul>
                    ...
                    @foreach ($categories as $category)
                    @if($loop->iteration <= 4) <li><a href="{{ route('course.list','category_id[]='.$category->id) }}">{{ $category->name}}</a></li>
                        @endif
                        @endforeach
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 col-6 mt-3">
                <ul>
                    <li class="mb-1"><b>Contact Us</b></li>
                   
                    <li><i class="fa fa-phone">&nbsp</i>{{ Sitehelpers::get_option('pageContact', 'telephone') }}</li>
                    <li><i class="fa fa-envelope">&nbsp</i>{{ Sitehelpers::get_option('pageContact', 'email') }}</li>
                    <li><i class="fa fa-map">&nbsp</i>{{ Sitehelpers::get_option('pageContact', 'address') }}</li>
