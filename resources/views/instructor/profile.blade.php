    		...
    		<div class="form-group col-md-4">
	            ...
	            <label class="cabinet center-block">
	                <figure class="course-image-container">
	                    ...
	                    <img src="@if(Storage::exists($instructor->instructor_image)){{ asset('storage/'.$instructor->instructor_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif" class="img-responsive" id="course_image-output" name="course_image-output" />
