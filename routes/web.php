...
Route::group(['middleware' => 'auth'], function () {
  ...
  Route::group(['middleware' => 'role:instructor'], function () {
    ...
    Route::group(['middleware' => 'role:admin'], function () {
      ...
      Route::post('admin/save-siswa', 'Admin\UserController@saveSiswa')->name('admin.saveSiswa');
      ...
      Route::get('admin/user/siswa/delete/{id}','Admin\UserController@deleteSiswa')->name('admin.hapusSiswa');
      // DONE Guru
      ...
      Route::get('admin/user/guru/delete/{id}','Admin\UserController@deleteGuru')->name('admin.hapusGuru');
      // DONE kategori
